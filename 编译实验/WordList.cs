        ...
        private int RecogSign(string str,int start_index)
        {
            for (int i = start_index; i < str.Length; i++)
            {
                ...
                else
                {
                    ...
                    _ListOfWord.Add(KeyWordTable.GetSignWord(temp, crtf_count.ToString() + ":" + char_count.ToString()));
        ...
        private int RecogWord(string str, int start_index)
        {
            for (int i = start_index; i < str.Length; i++)
            {
                ...
                else
                {
                    ...
                    _ListOfWord.Add(KeyWordTable.GetWord(temp, crtf_count.ToString() + ":" + char_count.ToString()));
